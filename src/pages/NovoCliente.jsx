...
function NovoCliente() {
  ...
  function salvarCliente(data) {
    addCliente(data).then((resposta) => {
      // 'resposta' representa o corpo de resposta que o back-end retornou para o front com a mansagem de sucesso que vem do back-end
      toast.success(resposta.message);
      navigate("/clientes");
    }).catch((err) => {
      // Caso ocorra algum erro, usamos o catch paara tratar
